    ...
    while (i < contents.size())
    {
        ...
        if (isdigit(c))
        {
            ...
            if (c == '0' && contents[i + 1] == 'b')
            {
                ...
                create_token(TokenType::BIT_LITERAL, contents.substr(start, i - start), start, i);
                continue;
            }
            ...
            if (c == '0' && contents[i + 1] == 'x')
            {
                ...
                create_token(TokenType::HEX_LITERAL, contents.substr(start, i - start), start, i);
                continue;
            }
            ...
            create_token(TokenType::INTEGER_LITERAL, contents.substr(start, i - start), start, i);
            continue;
        }
